...
# Parameters ranges
param_ranges = dict()
param_ranges['spectral_radius'] = np.arange(0, 1.1, 0.3)
param_ranges['leaky_rate'] = np.arange(0.1, 1.1, 0.3)
param_ranges['reservoir_size'] = np.arange(50, 510, 100)
param_ranges['connectivity'] = np.arange(0.1, 1.0, 0.3)
param_ranges['ridge_param'] = np.logspace(-10, 2, base=10, num=5)
param_ranges['input_scaling'] = np.arange(0.1, 1.1, 0.3)
param_ranges['bias_scaling'] = np.arange(0.0, 1.1, 0.3)
